...
import it.vitalegi.transmissiontelegrambot.telegram.request.processor.DeleteTelegramRequestProcessor;
...
@Service
public class DeleteTelegramMatcher extends AbstractTelegramMatcher {
	public static final String CMD = "delete";

	@Autowired
	protected DeleteTelegramRequestProcessor requestProcessor;
	@Autowired
