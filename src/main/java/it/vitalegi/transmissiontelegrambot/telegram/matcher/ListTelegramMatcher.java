...
import it.vitalegi.transmissiontelegrambot.telegram.request.processor.ListTelegramRequestProcessor;
...
@Service
public class ListTelegramMatcher extends AbstractTelegramMatcher {
	public static final String CMD = "list";

	@Autowired
	protected ListTelegramRequestProcessor requestProcessor;
	@Autowired
