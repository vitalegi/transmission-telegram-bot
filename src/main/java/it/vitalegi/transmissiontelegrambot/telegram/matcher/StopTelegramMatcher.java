...
import it.vitalegi.transmissiontelegrambot.telegram.request.processor.StopTelegramRequestProcessor;
...
@Service
public class StopTelegramMatcher extends AbstractTelegramMatcher {
	public static final String CMD = "stop";

	@Autowired
	protected StopTelegramRequestProcessor requestProcessor;
	@Autowired
